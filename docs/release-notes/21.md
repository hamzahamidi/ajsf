...
Correction, 2026-09-24: this note does not apply to 21. No `primeng` 21 release
declares `@angular/animations` as a peer dependency, and neither `21.0.0` nor
`21.1.10` imports it, so the install above is unnecessary. PrimeNG 20 was the
last major that needed it.
