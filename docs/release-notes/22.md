...
Correction, 2026-09-24: this note does not apply to 22. No `primeng` 22 release
declares `@angular/animations` as a peer dependency, `22.1.1` does not import it,
and a new Angular 22.2 project with `@ajsf/primeng` 22.2.1 and `primeng` 22.1.1
builds, renders and submits a form without it. PrimeNG 20 was the last major
that needed it.
